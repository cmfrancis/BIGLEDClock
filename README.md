...
# BigLED Wall Clock  
An Arduino UNO based temperature compensated, GPS enabled and battery backed GINORMOUS wall clock using 7" LED Digits from SparkFun and other materials from Adafruit.  
![Mounted](images/SilStemInstall.JPG)

![OVERVIEW](images/BIGLEDClock.png)  
